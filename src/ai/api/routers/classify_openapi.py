"""`/v1/classify` 의 **OpenAPI 표기 상수** — 문서 전용(2026-08-24 · №74).

🔴 **여기 있는 것은 「이름」뿐이다.** 런타임은 `classify.py` 가 그대로 하고, 이 모듈은
...
`post_classify_v1_classify_post` 였다 ⇒ 🔴 **통신테스트 전에 고정한다.**
...
CLASSIFY_OPERATION_ID: Final = "classifyInquiry"

#: `/docs` 한 줄 요약.
CLASSIFY_SUMMARY: Final = "학부모 문의를 분류한다"
