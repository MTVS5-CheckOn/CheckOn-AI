"""`/v1/confirmations` 의 **OpenAPI 표기 상수** — 문서 전용(2026-08-24 · №74).

🔴 **여기 있는 것은 「이름」뿐이다.** 런타임은 `confirmations.py` 가 그대로 하고, 이 모듈은
...
`post_confirmations_v1_confirmations_post` 였다 ⇒ 🔴 **통신테스트 전에 고정한다.**
...
CONFIRMATIONS_OPERATION_ID: Final = "confirmSuggestion"

#: `/docs` 한 줄 요약.
CONFIRMATIONS_SUMMARY: Final = "강사 확정 결과를 회신한다"
