...
class WeeklyActivityEvidence(_EvidenceBase):
    ...
    `enrolled_seconds`는 해당 주 재원 구간을 초 단위로 나타낸 BE 필수값이다.
    0초 행은 전송하지 않으므로 1초 이상, 한 주 상한인 604800초 이하의 정수만 받는다.
    """
    ...
    enrolled_seconds: int = Field(ge=1, le=604800, strict=True)
