...
**실파일 산출물:** `curriculum_graph.yaml`은 언어 33 + 신규 4영역 각 6 = 총 57노드다. 문학 6노드는 현재 만료 작품 풀의 고전시가·현대시·현대소설로 모두 출제 가능하며, 극·수필처럼 풀이 없는 갈래는 넣지 않았다. 상세 실측은 [`09_integration_proposals.md`](09_integration_proposals.md) 끝 절을 따른다.
