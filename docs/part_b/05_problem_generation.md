...
| AI Hub `71857` 국어 교과 지문형 문제 | `local_data/` | 281 MB | **상업 이용 별도 협의** | ⛔ W18 — 쓸 수 없다 |
...
⚠ **그래도 v1에서는 쓰지 않는다.** AI Hub 이용정책이 **상업적 이용·판매는 구축기관과 별도 협의**를 요구한다. 우리는 상용 SaaS다. 협의 없이 문항 생성·평가 경로에 넣으면 안 된다 — `local_data/` 보관까지만 하고 `09` §3 W18로 올렸다.
